...
export class CheckinController {
  ...
  async verifyQr(@Body() dto: VerifyQrDto, @CurrentUser('id') volunteerUserId: string) {
  ...
  @Post('manual-lookup')
  @HttpCode(HttpStatus.OK)
  async manualLookup(@Body() dto: ManualLookupDto, @CurrentUser('id') volunteerUserId: string) {
